...
Title <- "This is an invalid reference"
```
...
> Authors, (1990). **`r Title`**. Name of journal/book <https://doi.org/xxx/xxx>

Our pre-print is online here:

> Authors, (1678). *`r Title`*. Name of journal/book, Accessed
...
> Authors, (`r format(Sys.Date(), "%Y")`). *Compendium of R code and
...
-   [:file_folder: text](manuscript/Manuscript.qmd): Quarto source
    ...
    latest version of the figures from the /figures folder. There is
    also a rendered html version, `Manuscript.html`, suitable for
    reading.
...
-   [:file_folder: source_data](manuscript/source_data): Source data
    files associated with each figure containing all data points that
    have been plotted in the figure. These files should be submitted
